                    ...
                    <div class="col-12">
                        <div class="product-carousel-4 mbn-50 slick-row-15 slick-arrow-style">
                            <!-- product single item start -->
								<?php
									// Get products from the database with sub-categories
                                    $products = $shoe->getProducts($dbcon);
                            ...
                            <div class="product-item mb-50">
                               ...
                               <a href="#product details.php">
							    <a href="#product details.php?id=<?php echo $row->id;?>">
                                        <img height="200"src="assets/img/product/<?php echo $row->image?>" alt="">
                                    </a>
                                </div>
                                <div class="product-content">
                                    ...
                                    <div class="price-box">
                                        <span class="price-regular">CAD <?php echo $row->price?></span>
                    ...
                    <div class="col-12">
                        <div class="testimonial-inner bg-img" data-bg="assets/img/banner/banner-bg.jpg">
                            ...
                            <div class="testimonial-active slick-dot-style slick-dot-style__style-2">
								...
								<?php
									// Get feedback with user details from the database using the Shoe model
                                    $feedbacks = $shoe->getFeedbackWithUserDetails($dbcon);
                                ...
                                <div class="slider-item">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="testimonial-content">
                                            <h5 class="client"><?php echo $row->name?></h5>
